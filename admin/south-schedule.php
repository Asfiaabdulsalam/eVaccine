...
// Modified query to show all statuses (not just pending)
$sql = "SELECT vs.*, c.name AS child_name, v.name AS vaccine_name, h.name AS hospital_name
        ...
        WHERE vs.hospital_id = 1";  // Removed the status filter
    ...
    <aside class="left-sidebar" style="margin-top: 6px;">
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                  <h3 style="color: #025f66; margin-top: 10px">South City</h3>
        ...
        <div class="container-fluid">
          ...
          <div class="row" style="margin-top: -30px;">
            ...
            <div class="col-12">
                      ...
                      <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                          <tr>
                            ...
                            <td class="px-3">
                              <?php
                              // Status badge (matches your reference style exactly)
              ...
              <i class="ti ti-check me-1"></i>Approve</button>';

                                echo '<button type="submit" name="new_status" value="Missed" 
              class="btn btn-danger btn-sm">
              <i class="ti ti-x me-1"></i>Reject</button>';
